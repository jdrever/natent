              ...
              <div class="accordion-item">
                ...
                <div class="accordion-item">
                  <h2 class="accordion-appreciations" id="headingAppreciations">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                      data-bs-target="#collapseAppreciations" aria-expanded="false"
                      aria-controls="collapseAppreciations">
                      See Latest Appreciations<span class="badge text-bg-primary m-2">3</span>
                    </button>
                  </h2>
                  <div id="collapseAppreciations" class="accordion-collapse collapse"
                    aria-labelledby="headingAppreciations">
                    <div class="accordion-body">
                      <p class="p-1 border">
                        <small>
