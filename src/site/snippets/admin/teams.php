...
<ul class="nav nav-tabs" id="adminTab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link<?=($selectedTab==='add') ? ' active' : '' ?>" id="add-tab" data-bs-toggle="tab" data-bs-target="#add" type="button" role="tab"
      aria-controls="add" aria-selected="<?=($selectedTab==='add') ? 'true' : 'false' ?>" ><?= t("Create a New Team","Create a New Team") ?></button>
  </li>
  <li class="nav-item" role="presentation">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" id="createTeamModalButton" name="createTeamModalButton">CREATE
              TEAM</button>
          </div>
        </div>
      </div>
