...
<div class="container mt-2 mb-4 border border-primary bg-light p-3">
  ...
  <form method="post" id="createTeamForm" name="createTeamForm">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="teamName" name="teamName" aria-describedby="teamNameHelp" required>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="teamPassword" name="teamPassword" value="<?=$newPassword?>" aria-describedby="passwordHelp" required readonly>
    ...
    <button type="submit" name="createTeamButton" id="createTeamButton" class="btn btn-primary">CREATE TEAM</button>
  </form>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="createTeamModalButton" name="createTeamModalButton">CREATE TEAM</button>
      </div>
    </div>
  </div>
</div>
        ...
        <tr>
            ...
            <td>
                <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                    ...
                    <input type="text" id="password" name="password" value="<?= $newResetPassword ?>" required aria-describedby="passwordHelp" readonly>
