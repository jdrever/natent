...
<div class="alert alert-info p-2" role="alert">
  ...
  <p><?=t("Everyone can explore the Natural Entrepreurs Learning Journey but to complete tasks and collaborate with other teams, you will need to register your school with the project","Everyone can explore the Natural Entrepreurs Learning Journey but to complete tasks and collaborate with other teams, you will need to register your school with the project")?>.</p>
